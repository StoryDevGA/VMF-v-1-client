...
const TYPE_LABELS = Object.freeze({
  ...
  [OUTCOME_KNOWLEDGE_PACK_TYPES.ET_RUNTIME]: 'ET Runtime',
  [OUTCOME_KNOWLEDGE_PACK_TYPES.ET_RT]: 'ET Runtime (legacy)',
  [OUTCOME_KNOWLEDGE_PACK_TYPES.ERR]: 'ERR',
  [OUTCOME_KNOWLEDGE_PACK_TYPES.RGS]: 'RGS',
  [OUTCOME_KNOWLEDGE_PACK_TYPES.OBSERVATION_REGISTER]: 'Observation Register',
  [OUTCOME_KNOWLEDGE_PACK_TYPES.OR]: 'Observation Register (legacy)',
  [OUTCOME_KNOWLEDGE_PACK_TYPES.CCD]: 'CCD',
  [OUTCOME_KNOWLEDGE_PACK_TYPES.CCR]: 'CCR',
  [OUTCOME_KNOWLEDGE_PACK_TYPES.DIAGNOSTIC_EXTENSION]: 'Diagnostic Extension',
  [OUTCOME_KNOWLEDGE_PACK_TYPES.DX]: 'Diagnostic Extension (legacy)',
  [OUTCOME_KNOWLEDGE_PACK_TYPES.VALIDATION_EVIDENCE]: 'Validation Evidence',
  [OUTCOME_KNOWLEDGE_PACK_TYPES.VE]: 'Validation Evidence (legacy)',
  [OUTCOME_KNOWLEDGE_PACK_TYPES.CONTRADICTION_REGISTER]: 'Contradiction Register',
  [OUTCOME_KNOWLEDGE_PACK_TYPES.CR]: 'Contradiction Register (legacy)',
  ...
  [OUTCOME_KNOWLEDGE_PACK_TYPES.CHANNEL]: 'Channel',
  [OUTCOME_KNOWLEDGE_PACK_TYPES.COMMUNICATION_PATTERN]: 'Communication Pattern',
  [OUTCOME_KNOWLEDGE_PACK_TYPES.VISUAL_SYSTEM]: 'Visual System',
  [OUTCOME_KNOWLEDGE_PACK_TYPES.TRANSFORMATION]: 'Transformation',
  [OUTCOME_KNOWLEDGE_PACK_TYPES.TEMPLATE]: 'Template',
  [OUTCOME_KNOWLEDGE_PACK_TYPES.CATALOGUE]: 'Catalogue',
  [OUTCOME_KNOWLEDGE_PACK_TYPES.CAPABILITY]: 'Capability',
  [OUTCOME_KNOWLEDGE_PACK_TYPES.PROCESS]: 'Process',
  [OUTCOME_KNOWLEDGE_PACK_TYPES.ASSESSMENT_MODEL]: 'Assessment Model',
  [OUTCOME_KNOWLEDGE_PACK_TYPES.SCORING_MODEL]: 'Scoring Model',
  [OUTCOME_KNOWLEDGE_PACK_TYPES.QUESTION_LIBRARY]: 'Question Library',
  [OUTCOME_KNOWLEDGE_PACK_TYPES.FINDING_LIBRARY]: 'Finding Library',
  [OUTCOME_KNOWLEDGE_PACK_TYPES.RECOMMENDATION_LIBRARY]: 'Recommendation Library',
  [OUTCOME_KNOWLEDGE_PACK_TYPES.RISK_LIBRARY]: 'Risk Library',
  [OUTCOME_KNOWLEDGE_PACK_TYPES.METRIC_LIBRARY]: 'Metric Library',
  [OUTCOME_KNOWLEDGE_PACK_TYPES.TERMINOLOGY]: 'Terminology',
  [OUTCOME_KNOWLEDGE_PACK_TYPES.REFERENCE_DATA]: 'Reference Data',
  [OUTCOME_KNOWLEDGE_PACK_TYPES.RULE_SET]: 'Rule Set',
  [OUTCOME_KNOWLEDGE_PACK_TYPES.POLICY_DEFINITION]: 'Policy Definition',
  [OUTCOME_KNOWLEDGE_PACK_TYPES.GOVERNANCE_STANDARD]: 'Governance Standard',
  [OUTCOME_KNOWLEDGE_PACK_TYPES.QUALITY_STANDARD]: 'Quality Standard',
  [OUTCOME_KNOWLEDGE_PACK_TYPES.OUTPUT_TEMPLATE]: 'Output Template',
  [OUTCOME_KNOWLEDGE_PACK_TYPES.OUTPUT_PATTERN]: 'Output Pattern',
})
...
export const LEGACY_OUTCOME_KNOWLEDGE_PACK_TYPES = Object.freeze([
  OUTCOME_KNOWLEDGE_PACK_TYPES.ET_RT,
  OUTCOME_KNOWLEDGE_PACK_TYPES.OR,
  OUTCOME_KNOWLEDGE_PACK_TYPES.DX,
  OUTCOME_KNOWLEDGE_PACK_TYPES.VE,
  OUTCOME_KNOWLEDGE_PACK_TYPES.CR,
])

export const OUTCOME_KNOWLEDGE_PACK_AUTHORING_TYPE_OPTIONS = Object.freeze(
  OUTCOME_KNOWLEDGE_PACK_TYPE_OPTIONS.filter((option) =>
    option.value && !LEGACY_OUTCOME_KNOWLEDGE_PACK_TYPES.includes(option.value)),
)
...
export const KNOWLEDGE_PACK_PURPOSE_CATEGORY_OPTIONS = Object.freeze([
  ...
  Object.freeze({ value: 'COMMUNICATIONS', label: 'Communications' }),
  Object.freeze({ value: 'VISUAL', label: 'Visual' }),
  Object.freeze({ value: 'TRANSFORMATION', label: 'Transformation' }),
  Object.freeze({ value: 'CAPABILITY', label: 'Capability' }),
  Object.freeze({ value: 'PROCESS', label: 'Process' }),
  Object.freeze({ value: 'ASSESSMENT', label: 'Assessment' }),
