...
export function useAuditLogManagement() {
  ...
  const {
    ...
    systemEventType: filters.systemEventType.trim(),
    eventCategory: filters.eventCategory,
    eventSeverity: filters.eventSeverity,
    frameworkKey: filters.frameworkKey.trim(),
    frameworkVersion: filters.frameworkVersion.trim(),
    packageKey: filters.packageKey.trim(),
    componentType: filters.componentType.trim(),
    componentStableId: filters.componentStableId.trim(),
    componentVersion: filters.componentVersion.trim(),
    checksum: filters.checksum.trim(),
