export const ACTION_OPTIONS = [
  ...
  { value: 'CUSTOMER_CREDIT_ADJUSTED', label: 'CUSTOMER_CREDIT_ADJUSTED' },
  // License level
  { value: 'LICENSE_LEVEL_CREATED', label: 'LICENSE_LEVEL_CREATED' },
  { value: 'LICENSE_LEVEL_UPDATED', label: 'LICENSE_LEVEL_UPDATED' },
  { value: 'LICENSE_LEVEL_DEACTIVATED', label: 'LICENSE_LEVEL_DEACTIVATED' },
  // Role
  ...
  { value: 'KNOWLEDGE_PACK_GOVERNANCE_MAPPING_APPLIED', label: 'KNOWLEDGE_PACK_GOVERNANCE_MAPPING_APPLIED' },
  { value: 'SS005_BOUNDARY_POLICY_APPLIED', label: 'SS005_BOUNDARY_POLICY_APPLIED' },
  ...
  { value: 'RUNTIME_RELEASE_ADOPTED', label: 'RUNTIME_RELEASE_ADOPTED' },
  { value: 'RUNTIME_RELEASE_ROLLED_BACK', label: 'RUNTIME_RELEASE_ROLLED_BACK' },
  ...
  { value: 'OUTCOME_KNOWLEDGE_COMPOSITION_PLAN_CREATED', label: 'OUTCOME_KNOWLEDGE_COMPOSITION_PLAN_CREATED' },
  { value: 'OUTCOME_QUALITY_STAGE_RECORDED', label: 'OUTCOME_QUALITY_STAGE_RECORDED' },
  { value: 'PROMPT_SUBMITTED', label: 'PROMPT_SUBMITTED' },
  { value: 'OUTCOME_RESPONSE_GENERATED', label: 'OUTCOME_RESPONSE_GENERATED' },
  { value: 'OUTCOME_DRAFT_GENERATED', label: 'OUTCOME_DRAFT_GENERATED' },
  { value: 'OUTCOME_DRAFT_REFINED', label: 'OUTCOME_DRAFT_REFINED' },
  { value: 'OUTCOME_DRAFT_APPROVED', label: 'OUTCOME_DRAFT_APPROVED' },
  { value: 'OUTCOME_DRAFT_REVISED_FROM_APPROVED', label: 'OUTCOME_DRAFT_REVISED_FROM_APPROVED' },
  { value: 'OUTCOME_DRAFT_DISCARDED', label: 'OUTCOME_DRAFT_DISCARDED' },
  { value: 'OUTCOME_STUDIO_READINESS_REVISION_CREATED', label: 'OUTCOME_STUDIO_READINESS_REVISION_CREATED' },
  { value: 'OUTCOME_STUDIO_TEST_REFERENCE_UPLOADED', label: 'OUTCOME_STUDIO_TEST_REFERENCE_UPLOADED' },
  { value: 'OUTCOME_STUDIO_TEST_REFERENCE_APPROVED', label: 'OUTCOME_STUDIO_TEST_REFERENCE_APPROVED' },
  { value: 'OUTCOME_STUDIO_TEST_REFERENCE_SUPERSEDED', label: 'OUTCOME_STUDIO_TEST_REFERENCE_SUPERSEDED' },
  ...
  { value: 'GOVERNED_REASONING_EXECUTED', label: 'GOVERNED_REASONING_EXECUTED' },
  { value: 'GOVERNED_REASONING_BLOCKED', label: 'GOVERNED_REASONING_BLOCKED' },
  ...
  { value: 'KNOWLEDGE_PACK_REVIEW_STATUS_UPDATED', label: 'KNOWLEDGE_PACK_REVIEW_STATUS_UPDATED' },
  { value: 'KNOWLEDGE_PACK_DELETED', label: 'KNOWLEDGE_PACK_DELETED' },
...
export const RESOURCE_TYPE_OPTIONS = [
  ...
  { value: 'OutcomeKnowledgeCompositionPlan', label: 'OutcomeKnowledgeCompositionPlan' },
  { value: 'OutcomeQualityStageExecution', label: 'OutcomeQualityStageExecution' },
  { value: 'OutcomeDraft', label: 'OutcomeDraft' },
  { value: 'OutcomeAsset', label: 'OutcomeAsset' },
  { value: 'OutcomeStudioReadinessRevision', label: 'OutcomeStudioReadinessRevision' },
  { value: 'OutcomeStudioTestReferenceRevision', label: 'OutcomeStudioTestReferenceRevision' },
  { value: 'GovernedReasoningExecution', label: 'GovernedReasoningExecution' },
  { value: 'GovernedRuntimeArtifact', label: 'GovernedRuntimeArtifact' },
...
export const EVENT_CATEGORY_OPTIONS = [
  ...
  { value: 'KNOWLEDGE_PACK', label: 'KNOWLEDGE_PACK' },
